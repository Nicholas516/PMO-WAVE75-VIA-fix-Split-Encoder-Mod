...
🚀 Quick Start
Download the Wave75_Split_Encoder_Fixed.json from this repo.

Open the VIA Web App.

Navigate to the Settings tab and enable Show Design tab.

In the Design tab, toggle Use V2 definitions (deprecated) to ON.

Drag and drop the fixed .json file and connect your Wave75.
